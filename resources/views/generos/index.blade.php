                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    <input type="hidden" id="filter-crud-filter_crud_campo_pesquisar" value="generos.name">
                                    <input type="hidden" id="filter-crud-filter_crud_operacao_realizar" value="1">

                                    @php
                                        $selectCampoPesquisar = [
                                        ['value' => 'generos.name', 'descricao' => 'Nome']
                                        ];
                                    @endphp
...
@section('script')
    <!-- scripts_generos.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_generos.js')}}"></script>
@endsection
