...
@section('title') Nacionalidades @endsection
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    <input type="hidden" id="filter-crud-filter_crud_campo_pesquisar" value="nacionalidades.name">
                                    <input type="hidden" id="filter-crud-filter_crud_operacao_realizar" value="1">

                                    @php
                                        $selectCampoPesquisar = [
                                        ['value' => 'nacionalidades.name', 'descricao' => 'Nome']
                                        ];
                                    @endphp
...
<!-- Modal -->
@include('nacionalidades.form')
@endsection

@section('script')
    <!-- scripts_nacionalidades.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_nacionalidades.js')}}"></script>
@endsection
