        ...
        <div class="d-flex">
            <div class="navbar-brand-box">
                <a href="index" class="logo" id="aLogoDark">
                    <span class="logo-sm">
                        <img src="{{ asset('build/assets/images/image_logo_layout_dark_menu_min') }}" alt="" height="35" id="appImgLogoLayoutDarkMenuMin">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('build/assets/images/image_logo_layout_dark_menu') }}" alt="" height="35" id="appImgLogoLayoutDarkMenu">
                    </span>
                </a>

                <a href="index" class="logo" id="aLogoLight">
                    <span class="logo-sm">
                        <img src="{{ asset('build/assets/images/image_logo_layout_light_menu_min') }}" alt="" height="35" id="appImgLogoLayoutLightMenuMin">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('build/assets/images/image_logo_layout_light_menu') }}" alt="" height="35" id="appImgLogoLayoutLightMenu">
                    </span>
                </a>
            </div>
