...
@section('title') Estado Civil @endsection
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    <input type="hidden" id="filter-crud-filter_crud_campo_pesquisar" value="estados_civis.name">
                                    <input type="hidden" id="filter-crud-filter_crud_operacao_realizar" value="1">

                                    @php
                                        $selectCampoPesquisar = [
                                        ['value' => 'estados_civis.name', 'descricao' => 'Nome']
                                        ];
                                    @endphp
...
<!-- Modal -->
@include('estados_civis.form')
@endsection

@section('script')
    <!-- scripts_estados_civis.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_estados_civis.js')}}"></script>
@endsection
