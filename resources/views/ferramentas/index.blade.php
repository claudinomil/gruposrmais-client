...
@section('title') Ferramentas @endsection
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    <input type="hidden" id="filter-crud-filter_crud_campo_pesquisar" value="ferramentas.name">
                                    <input type="hidden" id="filter-crud-filter_crud_operacao_realizar" value="1">

                                    @php
                                        $selectCampoPesquisar = [
                                        ['value' => 'ferramentas.name', 'descricao' => 'Nome'],
                                        ['value' => 'ferramentas.descricao', 'descricao' => 'Descrição']
                                        ];
                                    @endphp
...
<!-- Modal -->
@include('ferramentas.form')
@endsection

@section('script')
    <!-- scripts_ferramentas.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_ferramentas.js')}}"></script>
@endsection
